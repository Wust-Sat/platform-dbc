...
<ISO15745Profile xmlns="http://www.profibus.com/GSDML/2003/11/DeviceProfile" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.profibus.com/GSDML/2003/11/DeviceProfile ..\xsd\ISO15745Profile.xsd">
  <ProfileHeader>
    <ProfileIdentification>WUST-Sat OBC CANopen Definition</ProfileIdentification>
    <ProfileRevision>1.0</ProfileRevision>
    <ProfileName>WUST-Sat OBC</ProfileName>
  ...
  <ProfileBody DeviceType="CANopen" ProfileType="Device" xsi:type="ProfileBody_Device_CANopen">
    <!-- Device Identity -->
    <DeviceIdentity VendorID="0x00000057" VendorName="WUST" ProductCode="0x0000000D" ProductName="WUST-Sat OBC Module" RevisionNumber="0x00010000" OrderNumber="WUST-OBC-V1"/>
    <!-- Mandatory Objects -->
    <ApplicationObjectList>
      ...
      <ApplicationObject Index="1018" Name="Identity Object" ObjectType="9">
        ...
        <SubObject SubIndex="2" Name="Product Code" ObjectType="7" DataType="0007" AccessType="ro" DefaultValue="0x0000000D"/> <!-- Based on HW ID -->
        <SubObject SubIndex="3" Name="Revision Number" ObjectType="7" DataType="0007" AccessType="ro" DefaultValue="0x00010000"/> <!-- v1.0 -->
        <SubObject SubIndex="4" Name="Serial Number" ObjectType="7" DataType="0007" AccessType="ro" DefaultValue="0x00000002"/> <!-- Placeholder SN -->
      </ApplicationObject>
      <!-- Manufacturer Specific Objects for Testing -->
      <ApplicationObject Index="2000" SubIndex="0" Name="OBC Status Register" ObjectType="7" DataType="0005" AccessType="ro" DefaultValue="1"/> <!-- Simple readable byte (e.g., 1=OK) -->
    </ApplicationObjectList>
